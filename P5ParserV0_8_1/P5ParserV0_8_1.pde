...
//numbers         │x xxxx    |  x xx  x      D     x  xx      xxxxx xxxxxxxxxxx xxxx       xxxxxxxxxx    x /x xxx|xx  xxxxx    xx   xxxx xx xx xx x     xx        x  /     x x       xx                            xxx                                                           x x x│
//strings         │x  xxx    |  x xx  x            x  xx      xxx x xxxxxxxxxxx  x x       x  xxxxxxx    x /x xx |x   xxxxx    xx   xxxx xx  x x  x                          x       xx                                                 x                                        x x x│
